                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button class="btn btn-success jarak-top-kurang7"
                            onclick="window.location.href='/event/sponsor/tambah-sponsor'">Tambah Sponsor</button>
                                    ...
                                    <tr v-for="sponsor in sponsors">
                                        ...
                                        <td class="btn-crud">
                                            <button class="btn btn-secondary"
                                                @click.prevent="detailsponsor(sponsor.id)"><i
                                                    class="bi bi-eye"></i></button>
                                            <button class="btn btn-primary" @click.prevent="editsponsor(sponsor.id)"><i
                                                    class="bi bi-pencil-square"></i></button>
                                            <button class="btn btn-danger" @click.prevent="() => destroy(sponsor.id)"><i
...
// function destroy(id) {
//     router.delete('/event/sponsor/' + id)
// }

function editsponsor(id) {
    router.get('/event/sponsor/' + id + '/edit-sponsor')
}

function detailsponsor(id) {
    router.get('/event/sponsor/' + id + '/detail-sponsor')
}
