    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                ...
                <div id="menu-toggle" class="toggle-icon ms-auto"><i class="fadeIn animated bx bx-menu"></i></div>s
            </div>
            <!--navigation-->
...
const updateStatus = (pesan) => {
    ...
    axios.post(`/pesan-petugas/update-status/${pesan.id}`, { status: newStatus })
        .then(response => {
